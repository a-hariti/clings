...
int main(void) {
    ...
    cling_assert(max_byte == 255, "max_byte should be the maximum value for uint8_t");

    // The maximum possible value for a 32-bit signed integer is INT32_MAX (2147483647).
    int32_t max_int32 = INT32_MAX;

    cling_assert(max_int32 == 2147483647, "max_int32 should be the maximum value for int32_t");
